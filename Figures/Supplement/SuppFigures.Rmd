...
```{r child='Suppl_1/Suppl_1.rmd', cache=TRUE}
```

\newpage

```{r child='Suppl_2/Suppl_2.Rmd', cache=TRUE}
```

\newpage

```{r child='Suppl_3/Suppl_3.Rmd', cache=TRUE}
```
...
```{r child='Suppl_5/Suppl_5.Rmd', cache=TRUE}
```
