...
aggAll <- function(m,ll, params=c(), ags=NULL){
  bp <- c(b=0.5735, c=-1.7091, p3=0, bg = 0, coef_utr = 0, coef_orf = 0)
  bp <- c(bp,ags)
...
feature_files <- list.files("../../../Parameter_Optimization/data/McGeary_2019_processed/HEK_Features_McGeary_Scan/", full.names = T)
mirs_full <- gsub("\\.txt", "", list.files("../../../Parameter_Optimization/data/McGeary_2019_processed/HEK_Features_McGeary_Scan/", full.names = F))
