...
anno <- ScanMiRAnno(species = NULL, genome = BSgenome.Hsapiens.UCSC.hg19, ensdb = ensdb)
...
saveRDS(m, file="./data/hsa.12mirs.hg19.fullScan.GR.rds")
```
...
saveRDS(m2, file="./data/hsa.12mirs.hg19.UTR.fullScan.GR.rds")
```
...
saveRDS(m3, file="./data/hsa.12mirs.hg19.UTRcan.fullScan.GR.rds")
```
...
saveRDS(m4, file="./data/hsa.12mirs.hg19.can.fullScan.GR.rds")
```
