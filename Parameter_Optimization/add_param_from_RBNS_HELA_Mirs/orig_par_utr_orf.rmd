...
m <- readRDS("../hsa.12mirs.HELA.fullScan.GR.rds")
# prepare length data
...
ob <- read.delim("../data/GSE140217_HeLa_transfection_logtpm_batchnormalized.txt", row.names=1)
...
## Checking it out
```{r}
op_utr <- readRDS("orig_utr_orf.rds")
