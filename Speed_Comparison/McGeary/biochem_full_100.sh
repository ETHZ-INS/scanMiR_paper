...
mkdir TEMP_hek
cd TEMP_hek
RNAplfold -L 40 -W 80 -u 15 < $wd/inputs/hek_orf_utr3_100.fa
cd ..

mkdir rnaplfold_orf_utr3_hek_100
python $srcd/rnaplfold/process_mRNA_folding.py \
--transcripts $wd/inputs/hek_transcripts_100.txt \
--indir TEMP_hek \
--outdir rnaplfold_orf_utr3_hek_100
rm -r TEMP_hek
...
--rnaplfold_dir $wd/rnaplfold_orf_utr3_hek_100 \
--overlap_dist 12 \
--upstream_limit 15 \
--outfile $wd/outputs/scan100/"$mirname".txt ; \
done
