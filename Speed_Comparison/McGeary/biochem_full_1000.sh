...
mkdir TEMP_hek
cd TEMP_hek
RNAplfold -L 40 -W 80 -u 15 < $wd/inputs/hek_orf_utr3_1000.fa
cd ..

mkdir rnaplfold_orf_utr3_hek_1000
python $srcd/rnaplfold/process_mRNA_folding.py \
--transcripts $wd/inputs/hek_transcripts_1000.txt \
--indir TEMP_hek \
--outdir rnaplfold_orf_utr3_hek_1000
rm -r TEMP_hek
...
--rnaplfold_dir $wd/rnaplfold_orf_utr3_hek_1000 \
--overlap_dist 12 \
--upstream_limit 15 \
--outfile $wd/outputs/scan1000/"$mirname".txt ; \
done
