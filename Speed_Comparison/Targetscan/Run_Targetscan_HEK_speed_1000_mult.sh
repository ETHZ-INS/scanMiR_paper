...
--utr3_file $wd/Input/HEK_UTR_Seqs_df_1000.csv \
--tree_file $srcd/PCT_parameters/Tree.generic.txt \
--out $wd/Output/HEK_bin_out_1000.csv \
--ref_species='9606' \
--futures = True
...
--bin_file $wd/Output/HEK_bin_out_1000.csv \
--utr3_file $wd/Input/HEK_UTR_Seqs_df_1000.csv \
--tree_path $srcd/PCT_parameters/ \
--out $wd/Output/HEK_sites_out_1000.csv \
--ribosome_shadow=14 \
--ref_species='9606' \
--futures = True
...
--site_file $wd/Output/HEK_sites_out_1000.csv \
--ta_sps_file $srcd/calculate_features/TA_SPS_by_seed_region.txt \
--orf_file $wd/Input/HEK_ORF_Seqs_df_1000.csv \
--rnaplfold_temp $srcd/Temp/ \
--out $wd/Output/HEK_features_out_1000.csv \
--ref_species='9606' \
--futures = True
